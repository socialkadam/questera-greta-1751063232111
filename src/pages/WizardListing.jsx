...
function WizardListing() {
  ...
  return (
    <div className="min-h-screen bg-kadam-off-white">
      {/* Header */}
      <div className="kadam-gradient py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h1 className="font-display text-4xl font-bold text-kadam-deep-green mb-4">
              {getPageTitle()}
            </h1>
            <p className="text-xl text-kadam-deep-green max-w-3xl mx-auto">
              {getPageDescription()}
            </p>
            {isRecommended && (
